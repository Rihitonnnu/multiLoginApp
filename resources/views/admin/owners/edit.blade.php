                                    ...
                                    <div class="-m-2">
                                        <div class="p-2 w-1/2 mx-auto">
                                            <div class="relative">
                                                ...
                                                <input required type="text" value="{{ $owner->name }}" id="name"
                                                    name="name"
                                        ...
                                        <div class="p-2 w-1/2 mx-auto">
                                            <div class="relative">
                                                ...
                                                <div class="w-full bg-gray-300 bg-opacity-50 rounded focus:bg-white focus:ring-2 focus:ring-indigo-200 text-base outline-none text-gray-700 py-1 px-3 leading-8 transition-colors duration-200 ease-in-out">
                                                    {{$owner->shop->name}}
                                                </div>
                                            </div>
                                        </div>
                                        ...
                                        <div class="p-2 w-full flex justify-around mt-4">
                                            <button type="button"
                                                ...
                                                class="flex mx-auto text-white bg-indigo-500 border-0 py-2 px-8 focus:outline-none hover:bg-indigo-600 rounded text-lg">戻る</button>
                                            <button type="submit"
